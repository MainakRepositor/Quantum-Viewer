...
def about():
    ...
    # Create label
    label = tkinter.Label(info, text = "About Quantum Viewer:")
...
hadamard.grid(row=3, column=1, sticky='WENS', pady=1)
...
td_gate.grid(row=2,column=2,sticky='WE', pady=1)
...
quit.grid(row=3,column=0,columnspan=1,sticky='WE',ipadx=5, pady=1)
visualize.grid(row=3,column=2,columnspan=1,sticky='WE',ipadx=5, pady=1)
